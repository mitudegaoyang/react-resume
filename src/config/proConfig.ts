const BASECONFIG = [
  ...
  },
  {
    ...
    description: [
      '高质量发展建设管理是一个从规划到产出的管理闭环，起点是战略规划，终点是成果产出，',
      '以目标管理和差异管理作为两大抓手，其特点就是“要事优先，异常先见”，目标引领，动态纠偏。',
      '该系统包含多个模块和功能，以满足不同医院的需求，并有助于实现医疗行业的可持续发展和改进。',
      '模块包括运营指标驾驶舱、领导组织体系、高质量发展框架、建设进度管理等多个模块。',
      '该系统是一个全面的解决方案，帮助医院提高高质量发展建设、优化资源利用、提高医疗质量，并确保医院合规运营。',
      '这有助于实现医疗高质量发展的目标，提供更好的医疗服务，保障患者的健康和安全。'
    ],
    content: [
      '基于 Ant Design Pro 组件，实现各页面布局及特效；',
      '使用 single-spa 实现微服务项目架构；',
  ...
  },
  {
    ...
    description: [
      ...
      '通过对评审流程的优化和自动化，我们成功实现了评审标准的制定、',
      '医院自评、评审任务分解、资料上报与审核、评审进度掌控、',
      '评审条款督导、整改措施反馈等多个环节的管理。',
      '同时，系统还包含了委员会管理、医务管理、护理管理、医院院感管理等多个功能模块，',
      '以全方位支持医院的全面质量管理需求。'
    ],
    content: [
      '基于 Ant Design Pro 组件，实现各页面布局及特效；',
  ...
  },
  {
    ...
    description: [
      '使用antd、react进行迭代开发。项目分为概览、全息档案、智能搜索、布控预警、设备、媒资管理、系统管理几个模块。',
      '本人在项目中担任前端开发。',
  ...
  },
  {
    ...
    description: [
      '使用iView、vue实现官网PC版的重新构建。项目共分为首页、项目、活动、个人中心几个模块。',
      '本人在项目中担任前端开发。',
