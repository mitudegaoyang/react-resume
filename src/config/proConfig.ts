const BASECONFIG = [
  {
    ...
    href: '',
    description: [
      '智慧分析平台专为金融机构、企业和投资者设计，提供深度数据挖掘和专业信用评级服务，助力复杂金融环境下的明智决策。平台涵盖企业融资、政府公共融资、金融机构、结构融资、非标产品、主权及熊猫债评级等领域，集成首页、主体、区域和工具四大核心功能。',
    ...
    company: {
      name: '中诚信国际',
      src: 'https://img.bosszhipin.com/beijin/mcs/chatphoto/20210220/699efecf2819e4e08c45bc48d0073214e11ff0053389c45939c9ea7951226486_s.jpg?x-oss-process=image/resize,w_120,limit_0'
    },
